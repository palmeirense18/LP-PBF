...
export const EQUIPMENT: readonly Equipment[] = [
  {
    ...
    alt: "Five-axis vertical machining center on the production floor.",
    specs: [
  ...
  },
  {
    ...
    name: "Live-Tool Turret System",
    category: "Turning",
    image: "/machines/04-tt03-live-tool-turret.jpg",
    alt: "Close-up of a multi-station live-tool turret loaded with cutting tools.",
    specs: [
